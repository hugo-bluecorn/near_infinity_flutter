...
> Pinned: 2026-08-05
>
> **Note for near_infinity_flutter:** this is part of the target-side canon for the NearInfinity
> port (porting-BFB design). The MVVM bullet governs the app architecture. The State Management
> section's native-first default is **overridden by a declared deviation** — Riverpod 3.x,
> explicitly requested — see `nearinfinity-port-contract.md`, Deviations. Everything else applies
> as written.
